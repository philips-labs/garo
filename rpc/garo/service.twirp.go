...
/*
Package garo is a generated twirp stub package.
...
// ===================================
// AgentConfigurationService Interface
// ===================================
...
// =========================================
// AgentConfigurationService Protobuf Client
// =========================================

type agentConfigurationServiceProtobufClient struct {
	client HTTPClient
	urls   [1]string
	opts   twirp.ClientOptions
}

// NewAgentConfigurationServiceProtobufClient creates a Protobuf client that implements the AgentConfigurationService interface.
...
// =====================================
// AgentConfigurationService JSON Client
// =====================================

type agentConfigurationServiceJSONClient struct {
	client HTTPClient
	urls   [1]string
	opts   twirp.ClientOptions
}

// NewAgentConfigurationServiceJSONClient creates a JSON client that implements the AgentConfigurationService interface.
...
// ========================================
// AgentConfigurationService Server Handler
// ========================================

type agentConfigurationServiceServer struct {
	AgentConfigurationService
	hooks *twirp.ServerHooks
}

func NewAgentConfigurationServiceServer(svc AgentConfigurationService, hooks *twirp.ServerHooks) TwirpServer {
	return &agentConfigurationServiceServer{
		AgentConfigurationService: svc,
		hooks:                     hooks,
	}
}
...
func (s *agentConfigurationServiceServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// AgentConfigurationServicePathPrefix is used for all URL paths on a twirp AgentConfigurationService server.
// Requests are always: POST AgentConfigurationServicePathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const AgentConfigurationServicePathPrefix = "/twirp/philips.garo.garo.AgentConfigurationService/"

func (s *agentConfigurationServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "philips.garo.garo")
	ctx = ctxsetters.WithServiceName(ctx, "AgentConfigurationService")
...
func (s *agentConfigurationServiceServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *agentConfigurationServiceServer) ProtocGenTwirpVersion() string {
	return "v5.10.1"
}

func (s *agentConfigurationServiceServer) PathPrefix() string {
	return AgentConfigurationServicePathPrefix
}
